...
{    
    ...
    private const float sensMultiplier = 1;
    ...
    private float x, y;
    private bool grounded, jumping, sprinting, crouching;
    ...
    private void Look() {
        ...
        camTransform.localRotation = Quaternion.Euler(xRotation, desiredX, 0);
    ...
    private void OnCollisionStay(Collision other) {
        ...
        if (!cancellingGrounded)
        {
            ...
            Invoke(nameof(StopGrounded), Time.deltaTime * 3);
        }
    }
